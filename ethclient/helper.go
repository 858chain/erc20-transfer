...
func (client *Client) SuggestGasPrice(ctx context.Context) (*big.Int, error) {
	var hex hexutil.Big
	if err := client.rpcClient.CallContext(ctx, &hex, "eth_gasPrice"); err != nil {
		return nil, err
	}
...
func (client *Client) EstimateGas(ctx context.Context, msg ethereum.CallMsg) (uint64, error) {
	...
	err := client.rpcClient.CallContext(ctx, &hex, "eth_estimateGas", toCallArg(msg))
	if err != nil {
		return 0, err
	}
...
func (client *Client) PendingNonceAt(ctx context.Context, account common.Address) (uint64, error) {
	...
	err := client.rpcClient.CallContext(ctx, &result, "eth_getTransactionCount", account, "pending")
...
func (client *Client) NetworkID(ctx context.Context) (*big.Int, error) {
	version := new(big.Int)
	var ver string
	if err := client.rpcClient.CallContext(ctx, &ver, "net_version"); err != nil {
		return nil, err
	}
